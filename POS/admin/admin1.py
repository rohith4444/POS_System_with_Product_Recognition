...
Builder.load_file(r'C:\Users\MRR\OneDrive\Documents\Real Time Project\Software Development Files\POS With MongoDB\POS\admin\admin.kv')
...
class AdminWindow(BoxLayout):
    ...
    def view_stats(self):
        ...
        df = pd.read_csv(r'C:\Users\MRR\OneDrive\Documents\Real Time Project\Software Development Files\POS With MongoDB\POS\admin\products_purchase.csv')
        purchases = []
        dates = []
        count = 0
