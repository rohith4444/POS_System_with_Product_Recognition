...
Builder.load_file(r'C:\Users\MRR\OneDrive\Documents\Real Time Project\Software Development Files\POS With MongoDB\POS\Operator\operator.kv')
...
class OperatorWindow(BoxLayout):
    ...
    def update_purchases(self):
        ...
        if target_code == None:
            ...
            name = Label(text=str(target_code['product_name']),size_hint_x=.3,color=(.06,.45,.45,1))
